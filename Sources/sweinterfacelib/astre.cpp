...
string Astre::read_svg(int astre) {
    ...
    switch (astre) {
        case ASTRE_SOLEIL:
            return r + ASTRE_ASSET_SOLEIL;
        case ASTRE_LUNE:
            return r + ASTRE_ASSET_LUNE;
        case ASTRE_MERCURE:
            return r + ASTRE_ASSET_MERCURE;
        case ASTRE_VENUS:
            return r + ASTRE_ASSET_VENUS;
        case ASTRE_MARS:
            return r + ASTRE_ASSET_MARS;
        case ASTRE_JUPITER:
            return r + ASTRE_ASSET_JUPITER;
        case ASTRE_SATURN:
            return r + ASTRE_ASSET_SATURN;
        case ASTRE_URANUS:
            return r + ASTRE_ASSET_URANUS;
        case ASTRE_NEPTUNE:
            return r + ASTRE_ASSET_NEPTUNE;
        case ASTRE_PLUTON:
            return r + ASTRE_ASSET_PLUTON;
        case ASTRE_NOEUD_LUNAIRE:
            return r + ASTRE_ASSET_NOEUD_LUNAIRE;
        case ASTRE_CHIRON:
            return r + ASTRE_ASSET_CHIRON;
        case ASTRE_CERES:
            return r + ASTRE_ASSET_CERES;
        case ASTRE_NOEUD_LUNAIRE_SUD:
            return r + ASTRE_ASSET_NOEUD_LUNAIRE_SUD;
        default:
            return "";
    }
}
