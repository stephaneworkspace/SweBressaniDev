...
public class TextCore {
    ...
    public func personaliteJuridique() -> String {
        switch langue {
        case .F:
...
public class NumerologieCore {
    ...
    public static func lettreSimple(lettre: String) -> Int {
        let l: String = lettre.uppercased()
        switch l {
        case "A":
            return 1
    ...
    public static func chaineDeCaractereVersNombre(chars: String) -> Int {
        var nombre = 0
        for l in chars {
            let n: Int = NumerologieCore.lettreSimple(lettre: String(l))
            nombre = n + nombre
        }
        return nombre
    }
